...
pub trait StreamOnce {
    ...
    fn uncons(
        ...
        Self::Item,
        <Self::Error as ParsingError<Self::Item, Self::Range, Self::Position>>::StreamError,
    >;
}
    ...
    I::Item: Clone,
{
    ...
    fn uncons(
        &mut self,
        offset: usize,
    ) -> Result<I::Item, <I::Error as ParsingError<I::Item, I::Range, I::Position>>::StreamError> {
